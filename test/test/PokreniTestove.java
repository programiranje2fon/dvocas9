...
import zadatak1.BibliotekaTest;
import zadatak1.KnjigaTest;
import zadatak2.RestoranTest;
import zadatak2.VodicKrozRestoraneTest;
...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		runTestsForClass(KnjigaTest.class);
		runTestsForClass(BibliotekaTest.class);
		
		runTestsForClass(RestoranTest.class);
		runTestsForClass(VodicKrozRestoraneTest.class);
	}
